...
__device__ void updatePosition(int id,Parameters params, Particle* particleArray,Cell* cellArray,float deltaTime )
{
...
__global__ void runKernel(Parameters params, Particle* particleArray, Cell* cellArray, float deltaTime)
{
   ...
   updatePosition(id, params, particleArray, cellArray,deltaTime);
   __syncthreads();
